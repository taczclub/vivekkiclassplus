...
import '../services/notesubcategory.dart';

class NoteSubCategoryScreen extends StatelessWidget {
  final String id;
  NoteSubCategoryScreen({@required this.id});
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'Notes Sub Categories',
          style: GoogleFonts.ptSerif(fontWeight: FontWeight.w600),
        ),
      ),
      body: FutureBuilder(
        future: getNoteSubCategory(this.id),
