...
class NoteViewScreen extends StatefulWidget {
  final String title;
  final String pdf;
  NoteViewScreen({@required this.title, @required this.pdf});
...
class _NoteViewScreenState extends State<NoteViewScreen> {
  ...
  getFullPath() async {
    ...
    var res = await getNote(widget.pdf, remotePDFpath);
    print(res);
    setState(() {
      if (res['error']) {
      ...
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          ...
          onPressed: () {
            ...
            Navigator.of(context).pushReplacementNamed('note_view', arguments: {
              'title': widget.title,
              'pdf': widget.pdf,
            });
          },
