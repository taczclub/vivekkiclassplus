...
import 'package:vivekkiclassplus/screens/SociologyTestResultScreen.dart';
import 'package:vivekkiclassplus/screens/model.dart';

class SociologyTestPlayScreen extends StatefulWidget {
  final List<dynamic> questions;
  final String duration;
  SociologyTestPlayScreen({@required this.questions, @required this.duration});

  @override
  _SociologyTestPlayScreenState createState() =>
      _SociologyTestPlayScreenState();
}

class _SociologyTestPlayScreenState extends State<SociologyTestPlayScreen> {
