...
import 'package:vivekkiclassplus/screens/PpTestResultScreen.dart';
import 'package:vivekkiclassplus/screens/model.dart';

class PpTestPlayScreen extends StatefulWidget {
  final List<dynamic> questions;
  final String duration;
  PpTestPlayScreen({@required this.questions, @required this.duration});

  @override
  _PpTestPlayScreenState createState() => _PpTestPlayScreenState();
}

class _PpTestPlayScreenState extends State<PpTestPlayScreen> {
