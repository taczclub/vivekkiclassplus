...
import '../services/pptestsubcategory.dart';

class PpTestSubCategoryScreen extends StatelessWidget {
  final String id;
  PpTestSubCategoryScreen({@required this.id});
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'Pre PHD Test Sub Categories',
          style: GoogleFonts.ptSerif(fontWeight: FontWeight.w600),
        ),
      ),
      body: FutureBuilder(
        future: getPpTestSubCategory(this.id),
